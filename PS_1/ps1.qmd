...
```{python}
from analysis.q2a import berry_inversion_stargazer
berry_inversion_stargazer.custom_columns(['Logit', 'Nested Logit'])
berry_inversion_stargazer.title('Berry Inversion Results')
print(berry_inversion_stargazer.render_latex())
```
